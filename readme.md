...
npm run open
```
**NOTE**:update cypress.config.json
...
Please Click on the following link for AI optimized Test case for above mentioned test scenario 

[Daraz Test Scenario – Optimized AI Test Case](https://docs.google.com/document/d/13bgIkHgAFXmGLdlWA9omoMrzjgLznoNRq_SO6aHAzqU/edit?usp=sharing)